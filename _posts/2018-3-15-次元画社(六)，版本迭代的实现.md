---
layout: post
title: 次元画社(六)，版本迭代的实现
feature-img: "assets/img/pexels/wall_e.jpeg"
thumbnail: "assets/img/pexels/cyhs_ver.jpg"
tags: [Android, 次元画社]
---

## 一、前

​	当前软件的更新主要有两种方法，应用市场更新和软件内更新。本文实现了软件内检查更新，下载完成震动提示并自动安装。

## 二、服务类

​	在application标签下注册service

~~~ xml
<service android:name=".DownAPKService"/>
~~~
